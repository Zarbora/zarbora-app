...
export function GovernanceOverview({ societyId }: GovernanceOverviewProps) {
  ...
  if (loading) {
    return <div>Loading governance data...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Top Voter</CardTitle>
            <Vote className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress
                      value={(proposal.votes_for / proposal.total_votes) * 100}
                      className="h-2"
                    />
                    <div className="flex items-center justify-between text-sm">
                      <span>Against</span>
                    ...
                    <Progress
                      value={
                        (proposal.votes_against / proposal.total_votes) * 100
                      }
                      className="h-2"
                    />
                  </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        proposal.result === "passed" ? "default" : "destructive"
                      }
                    >
                ...
                <CardContent>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span>
                        {proposal.votes_for} For · {proposal.votes_against}{" "}
                        Against
                      </span>
                    </div>
                    <Progress
